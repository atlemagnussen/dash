...
import { GridAppConf, getTimestampId } from "./dash/index.js"
import "./components/faIcon"
import "./apps"
import * as dataService from "./backend/dataService.js"
import { GridAppPageConf } from "./backend/dataService.js"
              ...
              <li>
                <label for="adminmode">
                  ...
                  <input id="adminmode" 
                    ...
                    @change=${(e: Event) => this.adminModeChange(e)}>
                </label>
              </li>
              ${this.page ? html`
              <li>
